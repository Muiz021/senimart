                        ...
                        <tbody>
                            @foreach ($produk as $key => $item)
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a href="{{ route('produk.show',$item->id) }}" class="btn btn-info btn-sm me-2"><span><i class='bx bxs-show me-sm-2'></i> <span
                                                    class="d-none d-sm-inline-block">Show</span></span>
                                        </a>

                                        <a href="{{ route('produk.edit',$item->id) }}" class="btn btn-primary btn-sm me-2"><span><i
