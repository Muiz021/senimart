...
@push('style')
    <link rel="stylesheet" href="{{ asset('frontend/css/produk-kesenian.css') }}">
@endpush
...
@section('content')
    ...
    <section id="produk-kesenian">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-lg-3 bg-secondary h-100 py-0 py-lg-5">
                ...
                <div class="col-12 col-lg-9 px-0 px-lg-5">
                    <h2>Kategori Produk Kesenian</h2>
                 <div id="table">
                    @include('frontend.pages.produk.menu-produk')
                 </div>
    ...
    <script>
        $(document).ready(function() {
            $('input[name="jenis_seni_id"]').change(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: '/produk/sort', // Ganti dengan URL proses yang sesuai
                    data: {
